...
const NextImage = (props) => {
    return <div className="blog-post-image">
        <Image src={props.src} placeholder="blur" blurDataURL={`data:image/svg+xml;base64,${toBase64(shimmer(700, 475))}`} alt={props.alt} {...props} className="px-4 py-4 relative bottom-4" />
    </div>
}
